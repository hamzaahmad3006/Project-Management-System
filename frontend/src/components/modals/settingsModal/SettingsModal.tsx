                ...
                <div className="w-48 bg-gray-50 dark:bg-surface-sidebar border-r border-gray-200 dark:border-gray-800 flex flex-col">
                    ...
                    <nav className="flex-1 p-2 space-y-1">
                        ...
                        <div className="pl-4 flex justify-between items-start flex-col gap-2">
                            <h2 className="pb-4 text-sm font-medium text-content-primary dark:text-gray-300">Settings</h2>
                            <h2 className="pb-4 text-sm font-medium text-content-primary dark:text-gray-300">Teamspace</h2>
                            <h2 className="pb-4 text-sm font-medium text-content-primary dark:text-gray-300">Members</h2>
                            <h2 className="pb-4 text-sm font-medium text-content-primary dark:text-gray-300">Integration</h2>
                        </div>
                    </nav>
                </div>
