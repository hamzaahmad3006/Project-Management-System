                        ...
                        <div className="space-y-1.5">
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    required
                                />
                                <FaClock className="absolute left-2.5 top-3.5 text-gray-400 dark:text-gray-500" size={14} />
                            </div>
                        </div>
                        <div className="space-y-1.5">
                            <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300">End Time <span className="text-red-500">*</span></label>
                            <div className="relative">
                                <input
                                    type="datetime-local"
                                    value={endTime}
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-1.5">
                            ...
                            <div className="relative">
                                ...
                                <FaTags className="absolute left-2.5 top-3.5 text-gray-400 dark:text-gray-500" size={14} />
                            </div>
                        </div>
                        <div className="space-y-1.5">
                            <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300">Project (Optional)</label>
                            <div className="relative">
                                <select
                                    value={projectId}
