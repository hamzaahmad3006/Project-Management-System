        ...
        <div className="p-4 md:p-6 bg-surface-light dark:bg-surface-dark min-h-screen">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                <div className="bg-surface-pure dark:bg-surface-card border border-gray-200 dark:border-gray-800 rounded-lg p-4">
                    ...
                    <div className="flex items-end justify-between">
                        <span className="text-[21px] font-medium text-content-value dark:text-gray-100">{kpis?.tasks?.total || 0}</span>
                ...
                <div className="bg-surface-pure dark:bg-surface-card border border-gray-200 dark:border-gray-800 rounded-lg p-4">
                    <div className="flex items-center justify-between mb-2">
                        <span className="text-[16px] text-content-label dark:text-gray-400">In Progress Tasks</span>
                    </div>
                    <div className="flex items-end justify-between">
                        <span className="text-[21px] font-medium text-content-value dark:text-gray-100">{kpis?.tasks?.inProgress || 0}</span>
                        <div className="flex items-center gap-1 bg-green-100 text-green-600 text-sm">
                            <FaArrowUp size={12} className='rotate-45' />
                            <span>+3 points since yesterday</span>
                        </div>
                ...
                <div className="bg-surface-pure dark:bg-surface-card border border-gray-200 dark:border-gray-800 rounded-lg p-4">
                    <div className="flex items-center justify-between mb-2">
                        <span className="text-[16px] text-content-label dark:text-gray-400">Cancelled Tasks</span>
                    </div>
                    <div className="flex items-end justify-between">
                        <span className="text-[21px] font-medium text-content-value dark:text-gray-100">{kpis?.tasks?.canceled || 0}</span>
                        <div className="flex items-center gap-1 bg-red-100 text-red-600 text-sm">
                            <FaArrowDown size={12} className='-rotate-45' />
                            <span>-3 points since yesterday</span>
                        </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
                <div className="bg-white dark:bg-surface-card border border-gray-200 dark:border-gray-800 rounded-lg p-6">
                    <h3 className="text-[16px] font-normal mb-4 text-content-label dark:text-gray-100">Completion</h3>
                    <div className="relative w-48 h-48 mx-auto">
                        ...
                        <div className="absolute inset-0 flex flex-col items-center justify-center">
                            <span className="text-3xl italic font-bold text-content-primary dark:text-gray-100">{completionPercentage}%</span>
                            <span className="text-[12px]  text-content-muted dark:text-gray-400">Completed</span>
                        </div>
                    </div>
                    <div className="mt-4 space-y-2 text-sm">
                        <div className="flex justify-between">
                            <span className="text-content-muted text-[12px] font-normal dark:text-gray-400">Projects:</span>
                            <span className="font-normal text-content-muted text-[12px] dark:text-gray-100">{kpis?.projects?.active || 0}</span>
                        </div>
                        <div className="flex justify-between">
                            <span className="text-content-muted text-[12px] font-normal dark:text-gray-400">Completed Tasks:</span>
                            <span className="font-normal text-content-muted text-[12px] dark:text-gray-100">{kpis?.tasks?.completed || 0}/{kpis?.tasks?.total || 0}</span>
                        </div>
                    </div>
                </div>

                <div className="bg-white dark:bg-surface-card border border-gray-200 dark:border-gray-800 rounded-lg p-6">
                    <h3 className="text-lg font-semibold mb-4 text-content-label dark:text-gray-100">Schedule</h3>
            ...
            <div className="bg-white dark:bg-surface-card border border-gray-200 dark:border-gray-800 rounded-lg p-6">
                <h3 className="text-[16px] font-medium mb-4 text-content-label dark:text-gray-100">Latest Tasks</h3>
                            ...
                            <thead>
                                <tr className="border-b border-gray-200 dark:border-gray-800 text-left text-sm text-gray-600 dark:text-gray-400">
                                    <th className="pb-3 font-medium">
                                        <input type="checkbox" className="rounded bg-white dark:bg-gray-800 border-brand-muted  dark:border-gray-700" />
                                    </th>
                            ...
                            <tbody>
                                {latestTasks.map((task: DashboardTask) => (
                                    <tr key={task.id} className="border-b border-gray-100 dark:border-gray-800 text-sm text-gray-900 dark:text-gray-300">
                                        ...
                                        <td className="py-3 text-content-secondary dark:text-gray-400">{task.project?.name || 'N/A'}</td>
